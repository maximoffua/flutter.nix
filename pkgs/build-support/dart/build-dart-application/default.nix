{ lib, stdenv, callPackage, runCommand, symlinkJoin, writeText, dartHooks, makeWrapper, dart, cacert, nodejs, darwin, jq, fetchDartDeps }:
...
let
  ...
  packageOverrideRepository = (callPackage ../../../dart/package-overrides { }) // customPackageOverrides;
